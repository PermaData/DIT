#!/usr/bin/python
"""Replaces numbers greater than or equal to criteria with constant in a column."""
...
def replace_num_greater_equal(criteria, constant, print_flag, input_data_file=None,
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Replaces values <= criteria in "
                               "input_data_file and writes the result to output_data_file.")
...
if __name__ == '__main__':
    ...
    replace_num_greater_equal(args.criteria, args.constant, args.print_flag,
