...
def replace_num_greater_equal(criteria, constant, print, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    replace_num_greater_equal(args.criteria,args.constant, 
