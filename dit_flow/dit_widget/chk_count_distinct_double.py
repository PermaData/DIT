...
def chk_count_distinct_double(input_data_file=None, output_data_file=None, log_file=None):
    # Counts number of distinct values in a col A then corresponing distinct values in col B in input_data_file.
...
# count number records in column B for each distinct col A value
        logger.info('{:>5} {:>40} {:>40} {:>10} {:>10}'.format('Num','Col A Value','Col B Value','number','Percent'))	       
        count=0
...
# write results to log file
            for subset in col_b_distinct:
                ...
                logger.info('{:5.0f} {:>40} {:>40} {:10.0f} {:10.3f}'.format(count,value,subset,number,num_fraction))	       
