...
def parse_arguments():
    parser = ap.ArgumentParser(description="Replaces values between \
                                           startval and endval with constant in "
...
if __name__ == '__main__':
    ...
    replace_num_in_range(args.startval, args.endval, args.constant, args.print_flag,
