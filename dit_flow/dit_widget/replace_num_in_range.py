#!/usr/bin/python
"""Replaces numbers between startval and endval with constant in a column."""
...
def replace_num_in_range(startval, endval, constant, input_data_file=None, output_data_file=None, log_file=None):
    # Replaces values between startval and endval with constant in input_data_file and writes result to
    # output_data_file.
    ...
    with open(input_data_file, newline='') as _in, \
        ...
        logger.info('Replacing >{} and <{} with {}'.format(startval,endval,constant))
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Replaces values between startval and endval with constant in " \
...
if __name__ == '__main__':
    ...
    replace_num_in_range(args.startval, args.endval, 
