...
def replace_num_equal(criteria, constant, print_flag, input_data_file=None,
...
def parse_arguments():
    ...
    parser.add_argument('-o', '--output_data_file',
                        help='Step file to store output data.')
...
if __name__ == '__main__':
    ...
    replace_num_equal(args.criteria, args.constant, args.print_flag,
