#!/usr/bin/python
"""Subtract two columns (out = column_a - column_b)"""
...
def calc_subtract_col(missing_value, input_data_file=None, output_data_file=None, log_file=None):
...
def parse_arguments():
    parser = ap.ArgumentParser(description='Subtract two columns (out = column_a - column_b).')
...
if __name__ == '__main__':
    ...
    calc_subtract_col(args.missing_value, args.input_data_file, args.output_data_file, args.log_file)
