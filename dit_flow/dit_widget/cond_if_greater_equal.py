#!/usr/bin/python
"""If column A >= criteria in input_data_file column B = constant ."""
...
def cond_if_greater_equal(criteria, constant, print_flag, input_data_file=None,
...
def parse_arguments():
    parser = ap.ArgumentParser(description="If column A >= criteria \
                               in input_data_file column B = constant .")
...
if __name__ == '__main__':
    ...
    cond_if_greater_equal(args.criteria, args.constant, args.print_flag,
