...
def column_replace(TEMPFILE, TEMPMAP, DATAFILE, DATAMAP, FID, SID, DESTFILE,
                   DESTMAP, CROSSMAP, DATAFILE_OUT, DATAMAP_OUT, FID_OUT, SID_OUT,
    ...
    for tempfile, tempmap, datafile, datamap, fid, sid, destfile, destmap, crossmap in \
