...
def column_replace(TEMPFILE, TEMPMAP, DATAFILE, DATAMAP, FID, SID, DESTFILE,
    ...
    for tempfile, tempmap, datafile, datamap, fid, sid, destfile, destmap, crossmap, logfile in \
        zip(TEMPFILE.iter_contents(), TEMPMAP.iter_contents(),
            ...
            CROSSMAP.iter_contents(), LOGFILE.iter_contents()):
        ...
        # FIX: The introduction of crossmap may have solved this
