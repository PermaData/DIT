...
def replace_num_out_range(startval, endval, constant, print_flag, input_data_file=None,
    ...
    with open(input_data_file, newline='') as _in, \
            ...
            logger.info('Replacing values < {} or > {} with {}'.format(startval, endval, constant))
            if print_flag:
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Rnumbers < startval or > endval with constant in "
...
if __name__ == '__main__':
    ...
    replace_num_out_range(args.startval, args.endval, args.constant, args.print_flag,
