...
def replace_num_out_range(startval, endval, constant, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    replace_num_out_range(args.startval, args.endval, 
