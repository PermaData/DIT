...
def chk_print_num_in_range_equal(startval, endval, input_data_file=None, output_data_file=None, log_file=None):
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Prints values >= startval and values <= endval in input_data_file.")
