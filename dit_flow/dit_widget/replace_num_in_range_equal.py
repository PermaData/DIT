#!/usr/bin/python
"""Replaces numbers >=startval and <=endval with constant in a column."""
...
def replace_num_in_range_equal(startval, endval, constant, print_flag, input_data_file=None,
                               output_data_file=None, log_file=None):
    # Replaces values >=startval and <=endval with constant in input_data_file and writes result to
    # output_data_file.
...
if __name__ == '__main__':
    ...
    replace_num_in_range_equal(args.startval, args.endval, args.constant, args.print_flag,
