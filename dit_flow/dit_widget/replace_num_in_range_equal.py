...
def replace_num_in_range_equal(startval, endval, constant, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    replace_num_in_range_equal(args.startval, args.endval, 
