...
def calc_multiply_col(missing_value, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    calc_multiply_col(args.missing_value, args.input_data_file, args.output_data_file, args.log_file)
