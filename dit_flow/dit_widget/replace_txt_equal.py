...
def replace_txt_equal(target, replace, input_data_file=None, output_data_file=None, log_file=None):
    # Replaces target text string with replace in input_data_file and writes result to output_data_file.
...
if __name__ == '__main__':
    ...
    replace_txt_equal(args.target,args.replace, 
