...
# If column A = criteria in input_data_file column B = constant in output_data_file.
def cond_if_equal(criteria, constant, print_flag, input_data_file=None,
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Runs function on values = criteria in "
...
if __name__ == '__main__':
    ...
    cond_if_equal(args.criteria, args.constant, args.print_flag,
