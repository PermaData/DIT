#!/usr/bin/python
"""Squares all numeric values in a column file."""
...
def math_square(missing_value, input_data_file=None, output_data_file=None, log_file=None, log_level=DEFAULT_LOG_LEVEL):
    # Squares all values in input_data_file and writes result to
    # output_data_file.
    ...
    with open(input_data_file, newline='') as _in, \
            ...
            logger.info('Squares values in column')
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Squares all values in "
...
if __name__ == '__main__':
    ...
    math_square(args.missing_value,
