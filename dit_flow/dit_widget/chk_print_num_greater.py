#!/usr/bin/python
"""Prints name values > criteria in infile."""
...
def chk_print_num_greater(criteria, input_data_file=None, output_data_file=None, log_file=None, log_level=DEFAULT_LOG_LEVEL):
