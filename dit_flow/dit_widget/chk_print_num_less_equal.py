...
def chk_print_num_less_equal(criteria, input_data_file=None, output_data_file=None, log_file=None):
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Prints values <= criteria in  in input_data_file.")
...
if __name__ == '__main__':
    ...
    chk_print_num_less_equal(args.criteria,
