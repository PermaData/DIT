...
def chk_count_valid_records_txt(missing_value, input_data_file=None, output_data_file=None, log_file=None):
    ...
    with open(input_data_file, newline='') as _in:
        ...
        logger.info('{:10.0f} {:10.0f} {:10.3f}'.format(float(record),float(count),float(valid_fraction)))
...
if __name__ == '__main__':
    ...
    chk_count_valid_records_txt(args.missing_value,
