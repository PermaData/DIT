...
def cond_if_contains(criteria, constant, print_flag, input_data_file=None, output_data_file=None, log_file=None):
# If column A contains criteria, column B = constant.
...
def parse_arguments():
    parser = ap.ArgumentParser(description="If column A contains criteria, column B = constant.")
...
if __name__ == '__main__':
    ...
    cond_if_contains(args.criteria,args.constant,args.print_flag,
