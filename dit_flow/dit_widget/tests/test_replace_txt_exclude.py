...
def test_replace_txt_exclude(tmpdir):
    ...
    replace_txt_exclude('cde', 'xyz', True, log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
#    replace_txt_exclude('cde', 'xyz', True, log_file=out_log_file,                       output_data_file=out_file,                           input_data_file='{}'.format(temp_in_file.strpath))
    actual_out = temp_out_file.read()
    actual_log = temp_log_file.read()
    expected_out = 'xyz\nload of crap\npile'
    expected_log = 'Replacing fields containing cde with xyz\n'\
