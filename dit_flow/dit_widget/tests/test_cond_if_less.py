...
from dit_flow.dit_widget.cond_if_less import cond_if_less

def test_cond_if_less(tmpdir):
    ...
    cond_if_less(2, 'test', True,log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file=in_data_file)
#    cond_if_less(2, 'test', True,log_file=out_log_file,                       output_data_file=out_data_file,                      input_data_file=in_data_file)
