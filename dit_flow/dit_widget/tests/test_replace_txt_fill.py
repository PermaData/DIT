...
def test_replace_txt_fill(tmpdir):
    ...
    replace_txt_fill('xyz', log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
#    replace_txt_fill('xyz', log_file=out_log_file,                       output_data_file=out_file,                           input_data_file='{}'.format(temp_in_file.strpath))
    actual_out = temp_out_file.read()
    actual_log = temp_log_file.read()
    expected_out = 'xyz\nxyz\nxyz'
    expected_log = 'Filling with xyz\n\n\t Total number =3\n'
