...
def test_replace_txt_remove_left(tmpdir):
    ...
    replace_txt_remove_left('crap', log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
#    replace_txt_remove_left('crap', log_file=out_log_file,                       output_data_file=out_file,                           input_data_file='{}'.format(temp_in_file.strpath))
