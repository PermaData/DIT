...
from dit_flow.dit_widget.replace_num_greater_equal import replace_num_greater_equal

def test_replace_num_greater_equal(tmpdir):
    ...
    replace_num_greater_equal(2.0, -999.99, True, log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
