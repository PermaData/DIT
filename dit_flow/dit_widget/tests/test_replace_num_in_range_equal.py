...
def test_replace_num_in_range_equal(tmpdir):
    ...
    replace_num_in_range_equal(2.0, 4.0,-999.99, True, log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
