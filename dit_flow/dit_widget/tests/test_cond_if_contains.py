...
from dit_flow.dit_widget.cond_if_contains import cond_if_contains


def test_cond_if_contains(tmpdir):
    ...
    cond_if_contains(5, 'test', True, log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file=in_data_file)
#    cond_if_contains(5, 'test', True, log_file=out_log_file,                       output_data_file=out_data_file,                      input_data_file=in_data_file)
    actual_out = temp_out_file.read()
    actual_log = temp_log_file.read()
    expected_out = '1,Junk\n2,Junk\n3,Junk\n4,Junk\n5,test\n6,Junk\n'\
                   '1,Junk\n2,Junk\n3,Junk\n4,Junk\n5,test\n6,Junk\n'
    expected_log = 'If column A contains 5 set column B = test\n'\
