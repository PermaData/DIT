...
from dit_flow.dit_widget.calc_add_col import calc_add_col


def test_calc_add_col(tmpdir):
    ...
    calc_add_col(-999., input_data_file=in_data_file, output_data_file=temp_out_file.strpath, log_file=temp_log_file)
#    calc_add_col(-999.,input_data_file=in_data_file, output_data_file=out_file, log_file=out_log_file)
    actual_out = temp_out_file.read()
    actual_log = temp_log_file.read()
    expected_out = '2.0000000000\n-999.0000000000\n-999.0000000000\n-999.0000000000\n5.0000000000\n1.2345678806\n'
    expected_log = 'Add two columns (out = column_a +column_b)\n'
