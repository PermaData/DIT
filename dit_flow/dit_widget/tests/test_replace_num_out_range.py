...
def test_replace_num_out_range(tmpdir):
    ...
    replace_num_out_range(2.0, 4.0,-999.99, log_file='{}'.format(temp_log_file.strpath), output_data_file='{}'.format(temp_out_file.strpath), input_data_file='{}'.format(temp_in_file.strpath))
