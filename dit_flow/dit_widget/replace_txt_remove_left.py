#!/usr/bin/python
"""Removes all text to left of text string in a column."""
...
def replace_txt_remove_left(target, input_data_file=None, output_data_file=None, log_file=None):
    # Removes all text to left of text string in input_data_file and writes result to output_data_file.
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Removes all text to left of text string in" \
...
if __name__ == '__main__':
    ...
    replace_txt_remove_left(args.target, 
