...
def replace_num_less_equal(criteria, constant, print_flag, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    replace_num_less_equal(args.criteria, args.constant, args.print_flag,
