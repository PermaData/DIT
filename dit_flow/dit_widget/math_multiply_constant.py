...
def math_multiply_constant(constant, missing_value, input_data_file=None, output_data_file=None, log_file=None):
...
def parse_arguments():
    parser = ap.ArgumentParser(description="Multiplies all values in " \
                               "input_data_file and writes the result to " \
                               "output_data_file.")

    parser.add_argument('constant', type=float, help='Constant to multiply column values.')
...
if __name__ == '__main__':
    ...
    math_multiply_constant(args.constant, args.missing_value,
