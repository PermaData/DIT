#!/usr/bin/python
"""Replaces numbers greater than criteria with constant in a column."""
...
def replace_num_greater(criteria, constant, print_flag, input_data_file=None, output_data_file=None, log_file=None):
...
if __name__ == '__main__':
    ...
    replace_num_greater(args.criteria, args.constant, args.print_flag,
