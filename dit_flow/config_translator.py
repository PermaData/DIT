...
def translate(filename, flowname):
    ...
    with open(filename) as f:
        ...
        for sid, step, defn in zip(itertools.count(1), data['Step Order'],
            ...
            extracter, extract_init, extract_defn = make_extracter(sid, defn['input columns'])
            ...
            replacer, replace_init, replace_defn = make_replacer(sid, defn['output columns'])
            ...
            for item in defn['inputs']:
                ...
                new = data_connection(step, name.upper(), val)
